package com.emazon.stock.adapters.driving.rest.v1.controller;

import com.emazon.stock.adapters.driving.rest.v1.dto.request.PageQuery;
...
import com.emazon.stock.adapters.driving.rest.v1.utils.RestConstants;
...
public class ProductController {
    ...
    @PutMapping("/{id}/remove-supply")
    @PreAuthorize("hasAnyRole('ADMIN', 'WAREHOUSE_ASSISTANT', 'CUSTOMER')")
    public ResponseEntity<ProductResponse> removeSupplies(@PathVariable Long id, @RequestBody ProductRequest productRequest){
        productService.removeSupply(id, productRequest);
        return ResponseEntity.ok().build();
    }
